    ...
    function OracleGlEntryController($rootScope, $scope, $state, uiGridConstants, OracleGlEntryService) {
        ...
        vm.gridOptions = {
            ...
            columnDefs: [
              ...
              { name: 'Amount', field: 'Amount', sortId: null, enableSorting: false, headerCellClass: 'grid-align-right', cellFilter: 'number : 2' },//cell filter is used to arrange in decimal system
