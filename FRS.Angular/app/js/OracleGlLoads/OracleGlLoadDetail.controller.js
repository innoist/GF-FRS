...
//    OracleGlLoadController.$inject = ['$scope', '$state', '$stateParams', 'uiGridConstants', 'OracleGlLoadService'];

//    function OracleGlLoadController($scope, $state, $stateParams, uiGridConstants, OracleGlLoadService) {
...
//        if ($stateParams.Id !== "") {
//            paginationOptions.params.OracleGlLoadId = $stateParams.Id;
//            OracleGlLoadService.getMT940Detail($stateParams.Id, function (response) {
//                var load = response.Load;
//                var OracleGlLoad = response.OracleGlLoad;

//                vm.load = load;
//                vm.OracleGlLoad = OracleGlLoad;
//            });
//        }
...
//            OracleGlLoadService.getCustomerStatements(
