(function () {
    ...
    core.lazy.controller('SLoadTcontrollor', SLoadTcontrollor);

    SLoadTcontrollor.$inject = ['$state', 'uiGridConstants', 'sLoadTservice'];

    function SLoadTcontrollor($state, uiGridConstants, sLoadTservice) {
        ...
        sLoadTservice.getLoadTypes(function (response) {
            if (response) {
